                        ...
                        list.map((data, index) => (
                            <div key={index} className="flex items-start justify-items-start gap-2">
                                ...
                                <div className="flex flex-col items-start shrink">
                                    ...
                                    <div className="text-left w-full break-words flex items-center gap-1"
                                        title={(typeof data.diamondCount !== "undefined") ? `${data.diamondCount} each - Total ${data.diamondCount * data.repeatCount}` : ''
                                        }>
